        ...
        <div class="container">
            <table>
                ...
                <?php foreach ($data['lessonData'] as $details): ?>
                    <form class="form-horizontal" id="form" action="/MVC/teacher/decisionLearnerLesson" method="post">
                        <tr>
                            <td>
                                <?php
                                ...
                                <input hidden id="<?= $details['teacher_id'];?>" name="teacherId"
                                       value="  <?= $details['teacher_id'];?>">
                            ...
                            <td>
                                <?php if (($details['status'] == '1')) { ?>
                                    <button type="submit" name="action" class="btn btn-warning btn-sm" value="Cancel">
                                        Cancel Pending Lesson
                                    </button>
                                ...
                                <?php } elseif (($details['status'] == '3')) { ?>
                                    <button type="button" onclick="location.href='/MVC/account/myProfile';" name="action" class="btn btn-info btn-sm">
                                        Lesson Completed
                                    </button>
                                <?php } else { ?>
